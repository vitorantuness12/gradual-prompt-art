...
import { CheckCircle2, Clock, LogOut, Store } from "lucide-react";
...
function CourierStatusPage() {
  ...
  return <div className="min-h-dvh bg-[#fffaf5]"><header className="mx-auto flex w-full max-w-4xl items-center justify-between px-4 py-6"><div className="flex items-center gap-3"><img src={courierLogoAsset.url} alt="" width={320} height={320} className="size-11 rounded-xl object-cover" /><span className="font-black">Pedi Um Entregadores</span></div><Button variant="ghost" size="sm" onClick={() => void handleSignOut()}><LogOut className="mr-2 h-4 w-4" />Sair</Button></header>
