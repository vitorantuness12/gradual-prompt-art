...
export function StoreMobileNav({ slug, cartCount, onSearch, onCart }: StoreMobileNavProps) {
  const itemClass =
    "flex min-h-14 min-w-0 flex-col items-center justify-center gap-1 rounded-lg px-1 text-[11px] font-medium text-muted-foreground transition-colors active:scale-95";
    ...
    >
      <div className="mx-auto grid max-w-lg grid-cols-5">
        ...
        <Button
          ...
          variant="ghost"
          onClick={onSearch}
          className={`${itemClass} h-auto shadow-none`}
        >
        ...
        <Button
          ...
          variant="ghost"
          onClick={onCart}
          className={`${itemClass} relative h-auto shadow-none`}
        >
